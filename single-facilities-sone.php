...
/**
 * Template Name: 施設詳細ページ いこいの里 曽根壱番館
 */
get_header(); ?>
            ...
            <div class="p-facilities-single-top__wrap">
              ...
              <div class="p-facilities-single-top__text">
                <p class="p-facilities-single-top__text-item">
                  いこいの里曽根は九州労災病院バス停より徒歩約3分、すぐ隣に病院があり便利で安心な立地条件にあります。<br>
                  <br>
                  24時間職員が常駐しており、入居者様がいつでも安心して快適に過ごせるようお手伝いいたします。<br>
                  <br>
                  積み重ねてきた実績を活かし、入居者様の立場に立った介護サービスを心掛けてまいります。
                </p>
              </div>
            </div>
          </div>
            ...
            <div class="p-facilities-single-access__wrap">
              <div class="p-facilities-single-access__map-wrap">
                <div class="p-facilities-single-access__map">
                  <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3313.9709001065426!2d130.93745021520948!3d33.8388610806645!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x9efe205d0fe97053!2z44GE44GT44GE44Gu6YeMIOabveagueODu-WjseeVqumkqA!5e0!3m2!1sja!2sjp!4v1566451363827!5m2!1sja!2sjp" width="100%" height="350" frameborder="0" style="border:0" allowfullscreen=""></iframe>
                </div>
                <p class="align_r mr10 mb10 font11"><a href="https://maps.app.goo.gl/FE89sLpV6Ub8Yaph6" target="_blank" class="a_link">大きな地図で見る</a></p>
              </div>
              <div class="p-facilities-single-access__text">
                <dl class="p-facilities-single-access__list">
                  ...
                  <dd class="p-facilities-single-access__item">
                    〒800-0229<br class="forSP"> 福岡県北九州市小倉南区曽根北町2番5号<br>
                    TEL：093-474-3100<br class="forSP"> FAX：093-474-3120
                  </dd>
                </dl>
                <dl class="p-facilities-single-access__list">
