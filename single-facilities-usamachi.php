            ...
            <div class="p-facilities-single-top__wrap">
              ...
              <div class="p-facilities-single-top__text">
                <p class="p-facilities-single-top__text-item">
                  ...
                  <br>
                  また、市場が近いため散歩や、買物も入居者様と一緒に楽しみたいと思っております。活気ある生活を提供できるように職員一同頑張ります。
                </p>
              </div>
            </div>
          </div>
                ...
                <tbody>
                  ...
                  <tr>
                    <td class="color_orange border_n left pl">
                      <strong>月額合計<span class="forSP">135,200円</span></strong>
                    </td>
              ...
              <table class="p-facilities-single__table">
                ...
                <tbody>
                  <tr>
                    ...
                    <td class="align_c">要介護1 <br class="forSP">22,920円</td>
                    <td class="align_c">
                      158,120円
                    </td>
                  </tr>
                  <tr>
                    <td class="align_c">要介護2 <br class="forSP">24,000円</td>
                    <td class="align_c">
                      159,200円
                    </td>
                  </tr>
                  <tr>
                    <td class="align_c">要介護3 <br class="forSP">24,690円</td>
                    <td class="align_c">
                      159,890円</td>
                  </tr>
                  <tr>
                    <td class="align_c">要介護4 <br class="forSP">25,200円</td>
                    <td class="align_c">
                      160,400円</td>
                  </tr>
                  <tr>
                    <td class="align_c border_n">要介護5 <br class="forSP">25,740円</td>
