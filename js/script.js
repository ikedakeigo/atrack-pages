...
jQuery(function ($) {
    ...
    function calculatePrice(roomType, serviceType) {
        ...
        if (roomType === 'いこいの里小波瀬') {
            ...
            monthlyFee = 92000;
            monthlyFee2 = 0;
            roomUrl = '/介護付有料老人ホーム-いこいの里-小波瀬';
        } else if (roomType === 'GHいこいの里小波瀬') {
            initialCost = 100000;
            monthlyCost = 0;
            expenseCost = 0;
            otherCost = 0;
            ...
            monthlyFee = 153700;
            monthlyFee2 = 189700;
            roomUrl = '/住宅型有料老人ホーム-いこいの里-若園';
        } else if (roomType === 'いこいの里永犬丸') {
            initialCost = 0;
            monthlyCost = 20000;
            expenseCost = 8800;
            otherCost = 0;
            ...
            monthlyFee = 88200;
            monthlyFee2 = 0;
            roomUrl = '/住宅型有料老人ホーム-いこいの里-本城壱番館';
            ...
            monthlyFee = 107200;
            monthlyFee2 = 0;
            roomUrl = '/住宅型有料老人ホーム-いこいの里-本城弐番館';
        } else if (roomType === 'いこいの里徳吉') {
            initialCost = 0;
            monthlyCost = 20000;
            expenseCost = 8800;
            otherCost = 0;
            ...
            monthlyFee = 105700;
            monthlyFee2 = 0;
            roomUrl = '/住宅型有料老人ホーム-いこいの里-曽根壱番館';
            ...
            monthlyFee = 95700;
            monthlyFee2 = 0;
            roomUrl = '/住宅型有料老人ホーム-いこいの里-曽根弐番館';
