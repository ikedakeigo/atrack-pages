...
function my_theme_sidebar_widgets_init() {
    // サイドバー上段ウィジェットエリア
    register_sidebar( array(
        'name'          => 'サイドバー上段',
        'id'            => 'sidebar-top',
...
add_action( 'widgets_init', 'my_theme_sidebar_widgets_init' );


//ウィジェットにIDを使って固定ページのコンテンツを挿入　例[show_content id="123"]

function show_post_page_content_shortcode($atts) {
...
add_shortcode('show_content', 'show_post_page_content_shortcode');
