            ...
            <div class="p-facilities-single-price__wrap">
              ...
              <table class="p-facilities-single__table">
                <tbody>
                  ...
                  <tr>
                    <td class="left pl">
                      共済会費<span class='caution'>※2</span>
                  ...
                  <tr>
                    <td class="color_orange border_n left pl">
                      <strong>月額合計<span class="forSP">92,000円</span></strong>
                    </td>
              ...
              <span class='listMark-grid block'>※2 万一火災等に対して補償が受けられます。なお、掛け金は掛け捨てです。</span>
            </div>
            <div class="p-facilities-single-price__wrap">
              <h3 class="p-facilities-single-price__subT">
                <span class="pl_titleInner">
              ...
              <table class="p-facilities-single__table">
                ...
                <tbody>
                  <tr>
                    ...
                    <td class="align_c">要介護1 <br class="forSP">16,140円</td>
                    <td class="align_c">
                      108,140円
                    </td>
                  </tr>
                  <tr>
                    <td class="align_c">要介護2 <br class="forSP">18,120円</td>
                    <td class="align_c">
                      110,120円
                    </td>
                  </tr>
                  <tr>
                    <td class="align_c">要介護3 <br class="forSP">20,220円</td>
                    <td class="align_c">
                      112,220円</td>
                  </tr>
                  <tr>
                    <td class="align_c">要介護4 <br class="forSP">22,140円</td>
                    <td class="align_c">
                      114,140円</td>
                  </tr>
                  <tr>
                    <td class="align_c border_n">要介護5 <br class="forSP">24,210円</td>
              ...
              <span class='listMark-grid'>※別途、衛生管理費として月1,650円、洗濯代として月3,900円、ｼｬﾝﾌﾟｰ代として月500円、ﾚﾝﾀﾙ寝具代として月1,650円かかります。
              </span>
            </div>
            <div class="p-facilities-single-price__wrap">
              <h3 class="p-facilities-single-price__subT">
