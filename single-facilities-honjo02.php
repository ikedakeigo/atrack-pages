              ...
              <table class="p-facilities-single__table">
                <tbody>
                  ...
                  <tr>
                    ...
                    <td class="forPC2 pr align_r">8,000円</td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    <td class="color_orange border_n left pl">
                      <strong>月額合計<span class="forSP">107,200円</span></strong>
                    </td>
                    <td class="align_r color_orange border_n forPC2 pr"><strong>
                        107,200円
                      </strong></td>
                  </tr>
                </tbody>
              ...
              <table class="p-facilities-single__table">
                ...
                <tbody>
                  <tr>
                    ...
                    <td class="align_c">要介護1 <span class="forSP">88,200円</span>16,765円</td>
                    <td class="align_c">
                      123,965円
                    </td>
                  </tr>
                  <tr>
                    <td class="align_c">要介護2 <span class="forSP">88,200円</span>19,705円</td>
                    <td class="align_c">
                      126,905円
                    </td>
                  </tr>
                  <tr>
                    <td class="align_c">要介護3 <span class="forSP">88,200円</span>27,048円</td>
                    <td class="align_c">
                      134,248円</td>
                  </tr>
                  <tr>
                    <td class="align_c">要介護4 <span class="forSP">88,200円</span>30,938円</td>
                    <td class="align_c">
                      138,138円</td>
                  </tr>
                  <tr>
                    <td class="align_c border_n">要介護5 <span class="forSP">88,200円</span>36,217円</td>
